...
HD_PWD='D:/HikariMIPS/HikariMIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hikari_mips.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hikari_mips.tcl -notrace
