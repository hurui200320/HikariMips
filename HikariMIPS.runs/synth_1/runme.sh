...
HD_PWD='D:/HikariMIPS/HikariMIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hikari_mips.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hikari_mips.tcl
